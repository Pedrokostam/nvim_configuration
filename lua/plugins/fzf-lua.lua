return {
   ...
   keys = {
      ...
      { "<leader>fdg",  "<cmd>FzfLua lsp_document_diagnostics<cr>",   desc = "Document diagnostics" },
      { "<leader>fdG",  "<cmd>FzfLua lsp_workspace_diagnostics<cr>",  desc = "Workspace diagnostics" },
